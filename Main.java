    ...
    static class TutorHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                exchange.getResponseHeaders().set("Location", "/sucesso_tutor.html");
                exchange.sendResponseHeaders(302, -1);
            }
        }
    }
        ...
        public void handle(HttpExchange exchange) throws IOException {
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                if (tutor != null) {
                    ...
                    Pet.adicionar(pet);
                    exchange.getResponseHeaders().set("Location", "/sucesso_pet.html");
                    exchange.sendResponseHeaders(302, -1);
                } else {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                if (pet != null) {
                    ...
                    exchange.getResponseHeaders().set("Location", "/sucesso_consulta.html");
                    exchange.sendResponseHeaders(302, -1);
                } else {
